...
\SpecialSection{Introduction}
  ...
  original était de projeter sur un nombre inconnu de plans.
...
\SpecialSection{User Tracking}
  ...
  coordonnée en y en fonction de la position en hauteur du capteur. Pour la coordonnée de profonduer z, on se sert de la position du support de projection
...
\SpecialSection{Résultats}
  ...
  l'image. En effet, la calibration manuelle agissant sur le suivi de l'utilisateur s'est avéré très limitée. La position en hauteur du centre
  ...
  est proche du capteur. Néanmois, dans le cadre de nos experimentations, ces aléas n'ont pas influencé nos résultats mais doivent être pris en compte dans l'optique d'une
  ...
  réalisation du projet. C'est le cas de la modélisation 3D de la scène. Bien que convaincu de la réalisabilité des méthodes proposées tel que RANSAC 
  \cite{Quirk:2006:RDM:1130237.1130472}, les difficultées rencontrées lors de l'utilisation d'une scène connue nous ont poussé à assurer la qualité de
  nos méthodes dans cette situation. Ainsi, cette partie a été laissée de côté mais devrait pouvoir malgré tout compléter efficacement notre système si
  elle est correctement réalisée. De la même manière, nous avions envisagés de prendre en charge les distortions liées à la luminosité, mais le support
  sur lequel nous avons travaillé présentant des plans blancs et lambertiens ne nous a pas donné l'occasion de nous confronter à ce problème. Ainsi, 
  apporter ces corrections dans cette situation n'avait aucun interet. Par ailleurs, l'option visant à empêcher les pertes d'informations dans l'image 
  a également été négligée, le problème ne se présentant presque jamais durant nos experimentations.

  Bien entendu, nous nous sommes permis de ne pas développer ces parties car elles n'étaient pas essentielles à la réalisation d'un système répondant 
  avant tout au sujet.
...
\SpecialSection{Conclusion}
  ...
  permettre de prendre en charge les améliorations que nous avons considérées. Des travaux complémentaires devraient donc pouvoir être apportés 
  facilement.
