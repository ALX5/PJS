...
${OBJECTDIR}/geometry/HomographyCalculator.o: geometry/HomographyCalculator.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/geometry/HomographyCalculator.o geometry/HomographyCalculator.cpp

${OBJECTDIR}/geometry/main.o: geometry/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/geometry
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/geometry/main.o geometry/main.cpp
